...
Lors de votre première connexion à CleanOps, vous découvrez l'écran de connexion.

## Ouvrir l'écran

!!! info "TODO"
    Chemin de navigation dans CleanOps :
    sidebar > **Premiers pas** > **Première connexion**
...
!!! info "TODO"
    Source dans le code source : `Login.pas`
